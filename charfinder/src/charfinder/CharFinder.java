...
public class CharFinder {
	...
	public static void main(String[] args) {
		...
		System.out.println("the first character of " + s + " is " + ch.getFirstChar(s));
		System.out.println("the last character of " + s + " is " + ch.getLastChar(s));
	...
	void printAllPositions(String s){
		...
		while(currentPorition <= lastPosition){
			System.out.println(s.charAt(currentPorition) + " is at position: " + currentPorition);
		currentPorition++;
		}
	}
	...
	void getCharPos(String s, Character toFind){
		...
		while(currentPorition <= lastPosition){
			if(s.charAt(currentPorition) == toFind){
				System.out.println(toFind + " is at Position " + currentPorition + " of " + s);
			}
		}
	}
